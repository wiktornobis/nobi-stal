...
import springDiscs from '../../../assets/sprezyny-talerzowe.png';
...
function SpringDiscs(props) {
    ...
    return (
            ...
            <div className="sub-product general-container">
                <div className="spring-nav ">
                    ...
                    <img className='spring-nav-img'
                         ...
                         alt="" 
                    />
                    <h3 className="spring-nav-current">Sprężyny talerzowe</h3>
                </div>
                <div className="spring-compression">
                    <div className="left-container">
                        ...
                        <HashLink to="/produkty/4#talerzowe"
        ...
        <div className="springs-main-container general-container">
            <h3 id='talerzowe' className="springs-main-container-title">Sprężyny talerzowe</h3>
            <h4 className="springs-main-container-subtitle">Sprężyny talerzowe</h4>
        </div>
        <Outlet />
        </>
    );
